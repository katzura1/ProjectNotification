...
import com.example.acer.projectnotification.classPackage.DateTimeSorter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rb = new PengingatDB(getApplicationContext());
        ...
        List<Pengingat> mTest = rb.getAllReminders();
                ...
                case R.id.action_cancel:
                    ...
                    for (int i = IDmap.size(); i >= 0; i--) {
                        if (mMultiSelector.isSelected(i, 0)) {
                            ...
                            Pengingat temp = rb.getPenginat(id);
                            // Delete reminder
    ...
    private void selectReminder(int mClickID) {
        ...
        i.putExtra(EditActivity.EXTRA_REMINDER_ID, mStringClickID);
    ...
    public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.VerticalItemHolder> {
        ...
        public void onBindViewHolder(final VerticalItemHolder itemHolder, int position) {
            ...
            itemHolder.mDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    int id = IDmap.get(itemHolder.getAdapterPosition());
                    ...
                    rb.deleteReminder(temp);
                    // Remove reminder from recycler view
                    mAdapter.removeItemSelected(itemHolder.getAdapterPosition());
                    // Delete reminder alarm
                    mAlarmReceiver.cancelAlarm(getApplicationContext(), id);
        ...
        public class ReminderItem {
            ...
            public ReminderItem(String mTitle, String mDateTime, String mRepeatNo, String mRepeatType) {
                this.mTitle = mTitle;
        ...
        public class VerticalItemHolder extends SwappingHolder
            ...
            public VerticalItemHolder(View itemView, SimpleAdapter adapter) {
                ...
                mDelete = itemView.findViewById(R.id.del_button);
            }
...
//                itemView.setBackgroundColor(Color.DKGRAY);
            ...
            public void setReminderRepeatInfo(String repeatNo, String repeatType) {
                mRepeatInfoText.setText("Setiap " + repeatNo + " " + repeatType);
            }
        ...
        public ReminderItem generateDummyData() {
            return new ReminderItem("1", "2", "3", "4");
        }
        ...
        public List<ReminderItem> generateData(int count) {
            ...
            for (DateTimeSorter item : DateTimeSortList) {
                ...
                items.add(new SimpleAdapter.ReminderItem(Titles.get(i), DateAndTime.get(i),
                        RepeatNos.get(i), RepeatTypes.get(i)));
